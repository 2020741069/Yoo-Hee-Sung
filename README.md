      ...
      .text, .desc {   animation: fadeIn 1.2s ease-in-out forwards;  } @keyframes fadeIn {   from {     opacity: 0;   }   to {     opacity: 1;   }  } 
        ...
        >
          ...
          <path fill="#FFA883"  fill-opacity="1" d="m 0 0 l 854 200 l 0 -200 l -854 0 z"></path>
        </svg>
        ...
        <text text-anchor="middle" alignment-baseline="middle" x="60%" y="44%" class="desc" style="fill:#363636;">desc function is also rotated.</text>
      </svg>
